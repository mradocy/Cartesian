...
FullGame.Keys.refresh = function() {
    ...
    this.lmbHeld = (game.input.activePointer.isDown && game.input.activePointer.button == Phaser.Mouse.LEFT_BUTTON);
    ...
    this.mmbHeld = (game.input.activePointer.isDown && game.input.activePointer.button == Phaser.Mouse.MIDDLE_BUTTON);
    ...
    this.rmbHeld = ((game.input.activePointer.isDown && game.input.activePointer.button == Phaser.Mouse.RIGHT_BUTTON) || game.input.keyboard.isDown(Phaser.Keyboard.SHIFT));
